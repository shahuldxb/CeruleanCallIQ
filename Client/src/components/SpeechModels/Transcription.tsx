...
const Transcription: React.FC = () => {
  ...
  return (
    <div className="card p-4 ">
      ...
      <div className="grid grid-cols-2 mt-4 gap-4 h-[700px] ">
        <div className="border p-2 dark:text-gray-700">
          <h1 className="text-center  border-b p-2 ">Inbox</h1>
          <div className=" p-2 scrollable scrollbar-hide h-[620px]">
        ...
        <div className="border p-2 dark:text-gray-700">
          ...
          <div className=" p-2 scrollable scrollbar-hide max-h-[620px]"></div>
        </div>
      </div>
    </div>
  );
